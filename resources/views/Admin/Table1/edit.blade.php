...
<div class="detail-container">
        ...
        <div class="detail-header">
            <h4><i class="bi bi-box-arrow-up"></i> Detail Rental</h4>
        </div>
            ...
            <table class="detail-table">
                <tbody>
                    ...
                    <tr>
                        <th>Jam</th>
                        <td>:</td>
                        <td>{{ date('H:i', strtotime($booking->waktu_mulai)) }} - {{ date('H:i', strtotime($booking->waktu_akhir)) }}</td>
                    </tr>
                    <tr>
                        <th>Status Booking</th>
                        <td>:</td>
                        <td>
                            <span class="badge {{ $booking->status_booking == 'pending' ? 'badge-warning' : 'badge-success' }}">{{ ($booking->status_booking) }}</span>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <span class="badge {{ $booking->status_pembayaran == 'belum_dikonfirmasi' ? 'badge-warning' : 'badge-success' }}">{{ ($booking->status_pembayaran) }}</span>
                        </td>
                    </tr>
                    <tr>
                        <th>Total Denda</th>
    ...
    <!-- Modal -->
    <div class="modal fade" id="statusBooking" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @csrf
          <div class="form-check">
            <input class="form-check-input" type="radio" name="status_booked" id="statusPending" value="pending" @checked($booking->status_booking == 'pending')>
            <label class="form-check-label" for="statusPending">
              Pending
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="status_booked" id="statusBooked" value="booked" @checked($booking->status_booking == 'booked')>
            ...
            <form action="{{ url('set-status-pembayaran1/' . $booking->id) }}" method="post">
                ...
                <div class="modal-body">
                    <p>Ubah Status Pembayaran</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="belum_dikonfirmasi" name="status_pembayaran" id="pending" required @checked($booking->status_pembayaran == 'belum_dikonfirmasi')>
                                <label class="form-check-label" for="pending">
                                    Belum dikonfirmasi
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_pembayaran" value="sudah_dikonfirmasi" id="telahDibayar" required @checked($booking->status_pembayaran == 'sudah_dikonfirmasi')>
