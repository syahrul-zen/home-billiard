...
@section("container")
    <div class="detail-container">
        ...
        <div class="detail-header">
            <h4><i class="bi bi-box-arrow-up"></i> Detail Booking Meja 5</h4>
        </div>
        ...
        <div class="detail-card">
            ...
            <div class="action-buttons">
                ...
                <a href="{{ url("/table5") }}" class="btn-action btn-receipt">
                    Kembali
                </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url("set-status-booking5/" . $booking->id) }}" method="POST">
                        @csrf
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url("set-status-pembayaran5/" . $booking->id) }}" method="post">
                    @csrf
                    <div class="modal-header">
