...
<head>
    ...
    <title>Booking Billiard - Billiard Pro</title>
...
<body>
    <div class="booking-container">
        ...
        <div class="booking-header">
            ...
            <p class="location"><i class="bi bi-geo-alt me-2"></i>Kota Tangerang</p>
            <p class="address">Jl. Billiard No. 123, Tangerang, Banten</p>
        </div>
