    ...
    <style>
       ...
       .hero {
            background: linear-gradient(rgba(10, 36, 99, 0.7), rgba(10, 36, 99, 0.8)), 
                        url('https://media.istockphoto.com/id/509796074/id/foto/bola-biliar-di-meja-biliar-hijau.jpg?s=2048x2048&w=is&k=20&c=0h__qM4mSFeKYyPgY1XVMavE_dysVZNi-Kp_Nif-5HQ=') center/cover;
            color: white;
            padding: 120px 0;
            text-align: center;
            position: relative;
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-brand">
                        <i class="bi bi-circle-fill me-2" style="color: var(--accent-red);"></i>Billiard Pro
                    </div>
                    <p>Arena billiard premium dengan fasilitas terbaik untuk pengalaman bermain yang tak terlupakan.</p>
            ...
            <div class="text-center">
                <p>&copy; 2023 Billiard Pro. All rights reserved.</p>
            </div>
        </div>
    </footer>
