    ...
    <body>
        <div class="registration-container">
            ...
            <div class="registration-header">
                ...
                <p>Bergabunglah dengan komunitas billiard kami</p>
            </div>
            ...
            <div class="registration-card">
                ...
                <div class="success-message" id="successMessage">
                    ...
                    <strong>Registrasi Berhasil!</strong> Akun member Anda telah berhasil dibuat. Silakan login untuk
                    mulai
                    bermain.
                </div>
                ...
                <form method="POST" action="{{ url("/register") }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="image" onchange="previewImage()"
